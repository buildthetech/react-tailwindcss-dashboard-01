                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-row gap-5 items-start justify-center">
                        <div className="flex flex-col items-start gap-2">
                            <h1 className="font-bold text-gray-700 dark:text-gray-300 text-2xl">523,201</h1>
                        ...
                        <div className="flex flex-col items-start gap-2">
                            <h1 className="font-bold text-gray-700 dark:text-gray-300 text-2xl">379,237</h1>
                            <div className="flex flex-row items-center gap-2">
